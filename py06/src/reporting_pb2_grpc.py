...
class ReportingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.ReportCoordinates = channel.unary_stream(
                '/reporting.ReportingService/ReportCoordinates',
...
def add_ReportingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ReportCoordinates': grpc.unary_stream_rpc_method_handler(
                    servicer.ReportCoordinates,
